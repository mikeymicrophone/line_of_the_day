ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :lines, :has_one => [:user], :has_many => [:publications, :comments, :groups, :approaches, :goals, :list_items], :collection => {:mine => :get, :random => :get}, :member => {:inspect_content => :get}
